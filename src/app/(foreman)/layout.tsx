...
const navItems: NavItem[] = [
  ...
  { label: 'Messages', href: '/foreman/messages', icon: (a) => icon(<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" />, a) },
  ...
  { label: 'History', href: '/foreman/report/history', icon: (a) => icon(<><circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" /></>, a) },
