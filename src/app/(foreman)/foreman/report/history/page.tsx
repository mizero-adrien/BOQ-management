...
export default function ForemanReportHistoryPage() {
    ...
    <div className="min-h-screen" style={{ backgroundColor: '#F5F6FA' }}>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 px-4 text-center">
          ...
          <p className="text-xs mt-1" style={{ color: '#BBBBBB' }}>Submit a daily log to see it here</p>
        </div>
      ) : (
        <div className="space-y-2 p-4">
          {reports.map((r) => (
            <button key={r.id} type="button" onClick={() => router.push(`/foreman/report/${r.id}`)}
